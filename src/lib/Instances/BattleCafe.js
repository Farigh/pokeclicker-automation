...
class AutomationBattleCafe {
  ...
  static __internal__addInfo(sweetData, spinType, parent) {
    ...
    if (spinType == -1) {
      ...
      // Spin direction info
      if (
        spinType == GameConstants.AlcremieSpins.dayClockwiseBelow5 ||
        spinType == GameConstants.AlcremieSpins.dayClockwiseAbove5 ||
    ...
    this.__internal__caughtPokemonIndicators.set(pokemonName, {
      container: caughtIndicatorElem,
      pokemonId: pokemonId,
      currentStatus: null,
    });
    ...
    this.__internal__pokemonPokerusIndicators.set(pokemonName, {
      container: pokerusIndicatorElem,
      pokemonId: pokemonId,
      currentStatus: null,
    });
  }
