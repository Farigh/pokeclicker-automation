...
class AutomationFocusShadowPurification {
  ...
  static __internal__focusOnShadowPurification() {
    ...
    if (Automation.Utils.isInInstanceState()) {
      if (this.__internal__currentDungeonData == null || !this.__internal__doesDungeonHaveAnyUncaughtShadowPokemon(this.__internal__currentDungeonData.dungeon, true)) {
  ...
  static __internal__setNextShadowDungeon() {
    ...
    if (this.__internal__currentDungeonData != null && !this.__internal__doesDungeonHaveAnyUncaughtShadowPokemon(this.__internal__currentDungeonData.dungeon)) {
    ...
    this.__internal__currentDungeonData = this.__internal__shadowDungeonData.find(
      (data) =>
        this.__internal__doesDungeonHaveAnyUncaughtShadowPokemon(data.dungeon, true) &&
