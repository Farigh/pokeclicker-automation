...
class AutomationFocus {
  ...
  static __internal__buildMenu() {
    ...
    this.__internal__focusSelectElem.onchange = function () {
      Automation.Focus.__internal__focusOnChanged();
    };
    ...
    focusButton.onclick = function () {
      Automation.Menu.toggleButtonState(this.Settings.FeatureEnabled);
    }.bind(this);
  ...
  static __internal__buildFunctionalitiesList() {
    ...
    this.__internal__functionalities.push({
      ...
      name: "Money",
      tooltip:
        "Automatically moves to the best gym for money" +
    ...
    this.__internal__functionalities.push({
      ...
      name: "Dungeon Tokens",
      tooltip:
        "Moves to the best route to earn dungeon tokens" +
        Automation.Menu.TooltipSeparator +
   ...
   */
  static __internal__addFunctionalitySeparator(
    title,
    isUnlockedCallback = function () {
      return true;
    }
  ) {
    this.__internal__functionalities.push({
  ...
  static __internal__addGemsFocusFunctionalities() {
    ...
    for (const gemType of gemListCopy) {
      ...
      this.__internal__functionalities.push({
        ...
        tooltip:
          "Moves to the best gym or route to earn " +
          gemTypeName +
          " gems" +
          Automation.Menu.TooltipSeparator +
